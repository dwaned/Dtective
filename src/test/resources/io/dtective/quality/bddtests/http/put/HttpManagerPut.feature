...
Feature: HTTP PUT
  ...
  Scenario: Functional Test - Http PUT to a URL using JSON File
    When I send a POST to URL "{TestApi}/AddressbookModelsAPI" with request body from file "/src/test/resources/io/dtective/quality/bddtests/http/jsonAPIexample.json"
    Then response code is "201"
    And I store response body key "id" as "secondAddressbook"
    And I store contents of file "/src/test/resources/io/dtective/quality/bddtests/http/jsonAPIexample.json" in data-store "bodyForPUT"
